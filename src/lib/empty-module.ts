...
export const existsSync = function existsSync() {
  return false
}
export const statSync = noop
export const readdirSync = function readdirSync() {
  return []
}
...
export const isIP = function isIP() {
  return 0
}
export const isIPv4 = function isIPv4() {
  return false
}
export const isIPv6 = function isIPv6() {
  return false
}
