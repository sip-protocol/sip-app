...
export const SAMPLE_GALLERY: GeneratedArt[] = [
  {
    ...
    svgData: "",
    seed: deterministicSeed("bloom-aurora"),
    stealthAddress: `sip:solana:${deterministicSeed("bloom-aurora")}`,
    metaAddress: `st:sol:${deterministicSeed("bloom-aurora-meta")}`,
  ...
  },
  {
    ...
    svgData: "",
    seed: deterministicSeed("grid-cipher"),
    stealthAddress: `sip:solana:${deterministicSeed("grid-cipher")}`,
    metaAddress: `st:sol:${deterministicSeed("grid-cipher-meta")}`,
  ...
  },
  {
    ...
    svgData: "",
    seed: deterministicSeed("flow-wave"),
    stealthAddress: `sip:solana:${deterministicSeed("flow-wave")}`,
    metaAddress: `st:sol:${deterministicSeed("flow-wave-meta")}`,
    privacyLevel: PrivacyLevel.SHIELDED,
    createdAt: now - 3 * DAY,
  },
  {
    ...
    svgData: "",
    seed: deterministicSeed("bloom-nebula"),
    stealthAddress: `sip:solana:${deterministicSeed("bloom-nebula")}`,
    metaAddress: `st:sol:${deterministicSeed("bloom-nebula-meta")}`,
  ...
  },
  {
    ...
    svgData: "",
    seed: deterministicSeed("grid-matrix"),
    stealthAddress: `sip:solana:${deterministicSeed("grid-matrix")}`,
    metaAddress: `st:sol:${deterministicSeed("grid-matrix-meta")}`,
    privacyLevel: PrivacyLevel.SHIELDED,
