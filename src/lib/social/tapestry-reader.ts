...
function mapProfile(
  ...
  return {
    ...
    username,
    bio: p.bio ?? "",
    stealthAddress: `sip:solana:${deterministicHex(username, "a")}`,
    stealthMetaAddress: `st:sol:${deterministicHex(username, "b")}`,
    viewingPrivateKey: "1".repeat(44),
    spendingPrivateKey: "1".repeat(44),
