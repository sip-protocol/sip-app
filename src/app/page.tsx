...
const coreApps: AppCard[] = [
  {
    ...
    href: "/payments",
    icon: <PaperPlaneTiltIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/bridge",
    icon: <BridgeIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/wallet",
    icon: <WalletIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/dex",
    icon: <ArrowsClockwiseIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/enterprise",
    icon: <BuildingsIcon size={ICON_SIZE} weight="duotone" />,
...
const privacyApps: AppCard[] = [
  {
    ...
    href: "/governance",
    icon: <ScalesIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/social",
    icon: <MaskHappyIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/loyalty",
    icon: <TrophyIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/art",
    icon: <PaletteIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/migrations",
    icon: <LeafIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/channel",
    icon: <BroadcastIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/gaming",
    icon: <GameControllerIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/ticketing",
    icon: <TicketIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/metaverse",
    icon: <GlobeHemisphereWestIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/desci",
    icon: <DnaIcon size={ICON_SIZE} weight="duotone" />,
  ...
  },
  {
    ...
    href: "/music",
    icon: <MusicNoteIcon size={ICON_SIZE} weight="duotone" />,
    gradient: "from-pink-500 to-pink-700",
    sponsor: "Audius",
  },
]
...
import { DetectiveIcon, LockKeyIcon, EyeIcon } from "@phosphor-icons/react"

const HOW_IT_WORKS = [
  {
    icon: <DetectiveIcon size={28} weight="duotone" />,
