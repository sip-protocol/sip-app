...
interface SocialStatusProps {
  currentStep: SocialStep
  mode: "profile" | "post" | "follow"
  error?: string | null
  className?: string
}
...
const HEADERS: Record<string, { active: string; complete: string; failed: string }> = {
  profile: {
    active: "Creating Stealth Identity...",
    complete: "Identity Created!",
    failed: "Identity Creation Failed",
  },
  post: {
    active: "Publishing Post...",
    complete: "Post Published!",
    failed: "Post Failed",
  },
  follow: {
    active: "Following Profile...",
    complete: "Connected!",
...
export function SocialStatus({
  ...
  const finalSteps: SocialStep[] = ["profile_created", "published", "connected"]
