...
> = {
  ...
  publish: {
    active: "Publishing Drop...",
    complete: "Drop Published!",
...
export function ChannelStatus({
  ...
  const finalSteps: ChannelStep[] = ["subscribed", "published"]
  ...
  return (
    <div
      className={cn(
        ...
        !isFailed && !isComplete && "bg-purple-900/10 border-purple-800/50",
        className
      )}
    >
      {/* Header */}
      <div className="px-4 pt-4 pb-2">
        <p
          className={cn(
            ...
            !isFailed && !isComplete && "text-purple-300"
          )}
        >
          {isFailed
            ? header.failed
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center flex-shrink-0">
                  <div
                    className={cn(
                      ...
                      isCurrent &&
                        "bg-purple-500/20 text-purple-300 ring-2 ring-purple-500/40 animate-pulse",
                ...
                {isCurrent && !isComplete && (
                  <LoadingSpinner className="w-4 h-4 text-purple-400 ml-auto flex-shrink-0 mt-1" />
                )}
              </div>
            )
          })}
