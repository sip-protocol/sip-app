 ...
 */
export function createHeatmapColorScale(maxValue: number): d3.ScaleSequential<string> {
  return d3
 ...
 */
export function getRiskColor(risk: "critical" | "high" | "medium" | "low"): string {
 ...
 */
export function createGradientDefs(svg: d3.Selection<SVGSVGElement, unknown, null, undefined>) {
  ...
  scoreGradient.append("stop").attr("offset", "0%").attr("stop-color", riskColors.critical)
  scoreGradient.append("stop").attr("offset", "30%").attr("stop-color", riskColors.high)
  scoreGradient.append("stop").attr("offset", "50%").attr("stop-color", riskColors.medium)
  scoreGradient.append("stop").attr("offset", "100%").attr("stop-color", riskColors.low)
  ...
  sipGradient.append("stop").attr("offset", "100%").attr("stop-color", "#22c55e") // green
