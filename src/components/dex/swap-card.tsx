  ...
  return (
    <div className="card overflow-hidden" data-testid="swap-card">
      ...
      <div className="-my-2 flex justify-center">
        ...
        >
          <ArrowDownIcon size={16} className="text-gray-400" />
        </button>
      </div>
            ...
            <div className="mt-2 space-y-1">
              {zecValidation.isValid ? (
                ...
                <p
                  ...
                  role="alert"
                >
                  <XCircleIcon size={12} aria-hidden="true" />
                  {zecValidation.error}
                </p>
              )}
            </div>
        ...
        >
          <div className="mb-2 flex flex-wrap items-center justify-between gap-1 text-sm text-gray-400">
            <span className="flex items-center gap-1">
              {isSameChainPrivacy ? (
                <>
                  <ShieldIcon size={16} className="text-purple-500" />
                  <span className="text-xs sm:text-sm">
                ...
                <>
                  <WalletIcon size={16} className="text-gray-300" />
                  <span className="text-xs sm:text-sm">
                    Destination Address
                  </span>
                </>
