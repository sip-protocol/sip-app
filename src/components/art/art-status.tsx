...
export function ArtStatus({
  ...
  const finalSteps: ArtStep[] = ["generated", "minted"]
            ...
            return (
              ...
              >
                ...
                {isCurrent && !isComplete && (
                  <LoadingSpinner className="w-4 h-4 text-rose-400 ml-auto flex-shrink-0 mt-1" />
                )}
              </div>
            )
          })}
